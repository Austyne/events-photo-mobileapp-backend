...
public class SecurityConfig {
    ...
    /**
     * Main security filter chain - handles both public and protected endpoints
     */
    @Bean
    @Order(1)
    public SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers("/api/circles/shared/**").permitAll()
    ...
    public SecretKey secretKey(JwtProperties jwtProperties) throws NoSuchAlgorithmException {
        ...
        log.info("Secret Key: {}", secretKeyProperty);
